...
var unwrap = null;
var cast = Promise.resolve.bind(Promise);
window.asyncP = function (fn) { return async(fn, cast, unwrap); };
window.spawnP = function (fn) { return evaluate(fn.apply(null, Array.prototype.slice.call(arguments, 1)), cast, unwrap); };
window.evaluateP = function (generator) { return evaluate(generator, cast, unwrap); };
